...
class HomeTeleportationStrategy(private val homeName: String, private val home: Home, override val rule: HomesRule) : CustomTeleportationStrategy<HomesRule>() {

    override fun getLocation(context: CommandContext<ServerCommandSource>, spe: ServerPlayerEntity, player: Player) = home.location
