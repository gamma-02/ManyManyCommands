...
import ch.skyfy.manymanycommands.commands.*
...
class HomesCmd {
    ...
    private fun <S : ServerCommandSource> homesListForAnotherPlayer(commandContext: CommandContext<S>, suggestionsBuilder: SuggestionsBuilder): CompletableFuture<Suggestions> {
        ...
        val player = Configs.PLAYERS_CONFIG.serializableData.players.find { it.uuid == spe.uuidAsString } ?: return suggestionsBuilder.buildFuture()
